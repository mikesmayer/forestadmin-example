...
function GoogleAuthorizationFinder(renderingId, forestToken, envSecret) {
  this.perform = function () {
    return new P(function (resolve, reject) {
      ...
      request.get(forestUrl + '/forest/renderings/' + renderingId + '/google-authorization').set('forest-secret-key', envSecret).set('forest-token', forestToken).end(function (error, result) {
