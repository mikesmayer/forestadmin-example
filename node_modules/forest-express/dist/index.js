    ...
    if (opts.envSecret && opts.envSecret.length !== 64) {
      ...
      if (opts.envSecret) {
        ...
        var apimap = new JSONAPISerializer('collections', collections, {
          ...
          fields: {
            attributes: ['field', 'displayName', 'type', 'enums', 'collection_name', 'reference', 'column', 'isFilterable', 'widget', 'integration', 'isReadOnly', 'isVirtual', 'isRequired', 'defaultValue', 'validations', 'isSortable']
          },
          validations: {
