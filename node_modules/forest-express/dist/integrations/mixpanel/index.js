...
function Checker(opts, Implementation) {
  ...
  function isProperlyIntegrated() {
    return opts.integrations.mixpanel.apiKey && opts.integrations.mixpanel.apiSecret && opts.integrations.mixpanel.mapping && opts.integrations.mixpanel.mixpanel;
  }
  ...
  function isMappingValid() {
    ...
    if (!mappingValid) {
      logger.error('Cannot find some Mixpanel integration mapping values (' + opts.integrations.mixpanel.mapping + ') among the project models:\n' + _.keys(models).join(', '));
    }
