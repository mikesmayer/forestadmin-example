...
exports.createCollections = function (Implementation, apimap, schema, opts) {
  ...
  apimap.push({
    ...
    fields: [{ field: 'event', type: 'String', isFilterable: false }, { field: 'date', type: 'String', isFilterable: false }, { field: 'city', type: 'String', isFilterable: false }, { field: 'os', type: 'String', isFilterable: false }, { field: 'browser', type: 'String', isFilterable: false }, { field: 'browserVersion', type: 'String', isFilterable: false }, { field: 'id', type: 'String', isFilterable: false }]
  });
};
...
exports.createSegments = function (Implementation, model, schema, opts) {
  ...
  schema.segments.push({
    ...
    where: function where(params) {
      ...
      return panel.engage({
        selector: '(datetime(' + weekBeginning + ') < properties["$last_seen"])'
      }).then(function (data) {
        var where = {};
