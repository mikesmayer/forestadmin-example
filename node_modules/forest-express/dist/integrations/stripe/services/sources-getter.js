...
function SourcesGetter(Implementation, params, opts, integrationInfo) {
  ...
  this.perform = function () {
    ...
    return Implementation.Stripe.getCustomer(collectionModel, collectionFieldName, params.recordId).then(function (customer) {
      ...
      return getSources(customer[collectionFieldName], query).spread(function (count, sources) {
        return P.map(sources, function (source) {
          if (customer) {
            source.customer = customer;
          } else {
            return Implementation.Stripe.getCustomerByUserField(collectionModel, collectionFieldName, source.customer).then(function (customer) {
              source.customer = customer;
              return source;
            });
          }
