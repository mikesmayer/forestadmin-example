...
module.exports = function (app, model, Implementation, opts) {
  ...
  this.perform = function () {
    if (integrationInfo) {
      app.get(path.generate(modelName + '/:recordId/layer_conversations', opts), auth.ensureAuthenticated, this.conversations);

      app.get(path.generate(modelName + '_layer_conversations/:conversationId', opts), auth.ensureAuthenticated, this.conversation);

      app.get(path.generate(modelName + '_layer_conversations/:conversationId/relationships/messages', opts), auth.ensureAuthenticated, this.messages);
    }
  };
};