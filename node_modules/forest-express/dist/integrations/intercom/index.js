...
function IntercomChecker(opts, Implementation) {
  ...
  function isMappingValid() {
    ...
    if (!mappingValid) {
      logger.error('Cannot find some Intercom integration mapping values (' + opts.integrations.intercom.mapping + ') among the project models:\n' + _.keys(models).join(', '));
    }
  ...
  function isIntegrationDeprecated() {
    var integrationValid = opts.integrations.intercom.apiKey && opts.integrations.intercom.appId && opts.integrations.intercom.intercom && opts.integrations.intercom.mapping;
