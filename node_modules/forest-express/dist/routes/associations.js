...
module.exports = function (app, model, Implementation, integrator, opts) {
  ...
  function getAssociation(request) {
    return {
      associationName: _.first(_.last(request.route.path.split('/')).split('.csv'))
    };
  }
  ...
  function index(request, response, next) {
    ...
    return new Implementation.HasManyGetter(model, associationModel, opts, params).perform().then(function (results) {
      ...
      return new ResourceSerializer(Implementation, associationModel, records, integrator, opts, meta, fieldsSearched, params.search).perform();
  ...
  this.perform = function () {
    ...
    _.each(SchemaUtil.getHasManyAssociations(schema), function (association) {
      ...
      app.get(path.generate(modelName + '/:recordId/relationships/' + association.field, opts), auth.ensureAuthenticated, index);
